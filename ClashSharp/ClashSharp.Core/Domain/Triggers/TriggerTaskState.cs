...
public sealed class TriggerTaskState
{
    ...
    public static TriggerTaskState CreateInitial(TriggerTaskDefinition definition, long version = 0)
    {
        ...
        return new TriggerTaskState(definition.Id, definition.Revision, version, conditionStates);
    }
}
