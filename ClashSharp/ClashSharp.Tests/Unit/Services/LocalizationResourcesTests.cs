...
public sealed class LocalizationResourcesTests
{
    ...
    public void Translations_DoNotExposeRemovedBackupEntryPoints()
    {
        ...
        [
            ...
            "Settings.DataPackage.Scope.SystemLogs",
            "Settings.DataPackage.Scope.SystemLogs.Description",
        ];
    ...
    [InlineData("Settings.RestartSettingConfirm.Title")]
    [InlineData("Settings.RestartSettingConfirm.Message")]
    ...
    [InlineData("Settings.ResetGroupConfirm.ServiceDeploymentNote")]
    ...
    [InlineData("Settings.DataImport.Completed")]
    [InlineData("Settings.DataImport.Completed.Description")]
    [InlineData("Settings.DataImport.Invalid")]
    [InlineData("Settings.DataImport.Invalid.Description")]
    [InlineData("Settings.DataImport.Failed")]
    [InlineData("Settings.DataImport.Failed.Description")]
    ...
    [InlineData("Master.Tile.AppName")]
    ...
    [InlineData("Master.Tile.Description.AppName")]
    [InlineData("Master.Tile.Description.AppVersion")]
    [InlineData("Master.Tile.Description.AppRuntime")]
    [InlineData("Settings.RestartRequiredNotice")]
    [InlineData("Master.Status.Seconds.Format")]
    [InlineData("Master.Log.ApplyModeFailed")]
    ...
    [InlineData("Master.LatencyDialog.Description")]
    [InlineData("ProxyNodes.Latency.Direct")]
    [InlineData("ProxyNodes.Latency.NoEndpoint")]
    [InlineData("ProxyNodes.Latency.Failed")]
    ...
    [InlineData("Settings.Section.Notification")]
    [InlineData("Settings.Notification.Enabled.Title")]
    [InlineData("Settings.Notification.Enabled.Description")]
    [InlineData("Settings.Section.Triggers")]
    [InlineData("Settings.Triggers.Enabled.Title")]
    [InlineData("Settings.Triggers.Enabled.Description")]
    [InlineData("Settings.Triggers.Notifications.Title")]
    [InlineData("Settings.Triggers.Notifications.Description")]
    [InlineData("Settings.Section.Tray")]
    [InlineData("Settings.CloseBehavior.Title")]
    [InlineData("Settings.CloseBehavior.Description")]
    ...
    [InlineData("Settings.Tray.VisibleFeatures.Description")]
    [InlineData("Settings.Tray.VisibleFeatures.Summary.Format")]
    [InlineData("Settings.Tray.VisibleFeatures.SearchPlaceholder")]
    [InlineData("Settings.Tray.Feature.Status")]
    [InlineData("Settings.Tray.Feature.Status.Description")]
    [InlineData("Settings.Tray.Feature.Mode")]
    [InlineData("Settings.Tray.Feature.Mode.Description")]
    [InlineData("Settings.Tray.Feature.Pages")]
    [InlineData("Settings.Tray.Feature.Pages.Description")]
    [InlineData("Settings.Tray.Feature.TransparentProxy")]
    [InlineData("Settings.Tray.Feature.TransparentProxy.Description")]
    [InlineData("Settings.Tray.Feature.Settings")]
    [InlineData("Settings.Tray.Feature.Settings.Description")]
    [InlineData("Settings.Tray.Feature.SafeExit")]
    [InlineData("Settings.Tray.Feature.SafeExit.Description")]
    [InlineData("Notification.ProxyMode.Title")]
    [InlineData("Notification.ProxyMode.Message.Format")]
    [InlineData("Notification.TriggerFired.Title")]
    [InlineData("Notification.TriggerFired.Message.Format")]
    [InlineData("Notification.ConnectionTestTimeout.Title")]
    [InlineData("Notification.ConnectionTestTimeout.Message.Format")]
    [InlineData("Notification.Custom.Title")]
    [InlineData("Notification.Custom.Message")]
    [InlineData("Notification.Log.Shown")]
    [InlineData("Notification.Log.Suppressed")]
    [InlineData("Notification.Log.Failed")]
    [InlineData("Logs.Filter.SearchPlaceholder")]
    [InlineData("Logs.Filter.Level")]
    [InlineData("Logs.Filter.Category")]
    [InlineData("Logs.Filter.AllLevels")]
    [InlineData("Logs.Filter.AllCategories")]
    [InlineData("Logs.Column.Time")]
    [InlineData("Logs.Column.Level")]
    [InlineData("Logs.Column.Category")]
    [InlineData("Logs.Column.Content")]
    [InlineData("Logs.Empty")]
    [InlineData("Triggers.Log.Fired.Format")]
    [InlineData("ApplicationAction.UiPickerRequired.Format")]
    [InlineData("Command.Next")]
    [InlineData("Triggers.EnableAll")]
    [InlineData("Triggers.DisableAll")]
    [InlineData("Triggers.DisabledNotice")]
    [InlineData("Triggers.Add.NameStep")]
    [InlineData("Triggers.Add.ConditionStep")]
    [InlineData("Triggers.Add.ActionStep")]
    ...
    [InlineData("Startup.Log.ProxyBehaviorFailed")]
    [InlineData("Startup.Log.ConflictDialogSkipped")]
    [InlineData("Startup.Log.PromptSkipped")]
    [InlineData("Profiles.Log.FilePickerNoMainWindow")]
    [InlineData("Maintenance.LogClearFailed")]
    [InlineData("Maintenance.RuntimeCleanupFailed")]
    ...
    [InlineData("Diagnostic.UnsupportedCommand")]
    ...
    [InlineData("Close.Confirm.Title")]
    [InlineData("Close.Confirm.Message")]
