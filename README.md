...
> Development status (2026-09-07): Version 1.0.0 is in development. Page operations, accessible tiles, shared backup/restore interactions, connection filtering, and bounded log persistence have passed source and automated checks. An existing Clash configuration passed isolated semantic/core checks and 32/32 node probes, including HTTPS forwarding. The self-contained C# / WPF Installer remains gated pending signed-candidate installation and recovery validation; these results do not constitute a production release. Follow the [1.0.0 execution ledger](./docs/reviews/1.0.0-execution-ledger.md) for milestones, evidence, and remaining work, the [development baseline](./docs/reviews/2026-09-06-development-status-and-next-steps.md), and the [architecture audit](./docs/reviews/2026-08-31-project-structure-mvvm-code-quality-installer-audit.md).
