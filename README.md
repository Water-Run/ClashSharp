...
> Development status (2026-08-31): Clash# is undergoing production hardening and has no formal release yet. The self-contained C# / WPF installer is now the only Installer implementation. Its production runtime, parent engine, and authenticated helper are connected in source, but both default and formal packaging keep the mutation-runtime build gate disabled until one signed candidate passes the Windows VM E4 matrix. Source builds and development artifacts are not production-ready. See the [current structure, MVVM, code-quality, and Installer audit](./docs/reviews/2026-08-31-project-structure-mvvm-code-quality-installer-audit.md), [project development map](./docs/reviews/2026-08-27-project-development-map.md), [production-readiness execution plan](./docs/reviews/2026-08-27-production-readiness-execution-plan.md), and [detailed Installer rewrite audit](./docs/reviews/2026-08-30-installer-wpf-rewrite-audit.md).
