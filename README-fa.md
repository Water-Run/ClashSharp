...
> انتقال تنظیمات به نسل‌ها ادامه دارد. پاک‌سازی خودکار پوشه‌های خالی به حذف معمول برنامه متصل شده است؛ آزمون پذیرش کامل بسته نصب جدید هنوز باقی مانده است ([گزارش یکپارچه‌سازی](./docs/reviews/2026-09-22-installer-cleanup-integration.md)). جدول زیر مربوط به نقطه بازرسی تاریخی [`065a5d5`](https://github.com/Water-Run/ClashSharp/commit/065a5d5) با برچسب [`v1.0.0-checkpoint.20260912`](https://github.com/Water-Run/ClashSharp/releases/tag/v1.0.0-checkpoint.20260912) است.
