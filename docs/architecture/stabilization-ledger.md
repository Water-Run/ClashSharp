...
| P2-SET-01 | P2 | Application | In Progress | Phase 05 | shared StartupSettingsCoordinator now owns observed platform baseline, preference commit, compensation, and ordinary/trigger serialization; 47 new local regressions; `docs/design/2026-09-08-startup-settings-coordinator.md`; complete generation migration and native UI verification pending | — | — | — |
