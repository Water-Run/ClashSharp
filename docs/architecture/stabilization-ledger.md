...
| P1-06 | P1 | Application | In Progress | Phases 03 and 05 | `ApplicationMutationCoordinatorTests`; `RuntimeLifecycleCoordinatorTests`; `AppDataMaintenanceServiceTests`; `docs/architecture/evidence/phase-03-mutation-network-lifetime.md`; admitted reset decisions now use `SettingsResetCoordinator` with 44 new local regressions; `docs/design/2026-09-08-settings-reset-coordinator.md`; complete Phase 05 settings transaction matrix pending | — | structured self-review | — |
| P1-07 | P1 | Application | In Progress | Phase 05 | admitted import/runtime mutation paths now use `SettingsImportCoordinator`, shared runtime participants, and retained receipt ownership with 38 new local regressions; `docs/design/2026-09-08-settings-import-coordinator.md`; generation-backed settings authority and complete replay/rollback matrix pending | — | structured self-review | — |
...
| P2-SET-01 | P2 | Application | In Progress | Phase 05 | shared StartupSettingsCoordinator now owns observed platform baseline, preference commit, compensation, and ordinary/trigger serialization; 47 new local and CI regressions; `docs/design/2026-09-08-startup-settings-coordinator.md`; complete generation migration and native UI verification pending | — | — | — |
...
| P2-SET-03 | P2 | Presentation | In Progress | Phase 05 | connection-test dialog validation and batch saving fixed in `027d1c7`; custom accent batch in `b773f39`; six preference groups now reset as complete batches, with 26 new local regressions; `docs/design/2026-09-08-preference-group-reset.md`; startup group now uses an admitted retained transaction with 15 new local regressions; `docs/design/2026-09-08-startup-group-reset.md`; proxy and transparent-proxy groups now use the same retained transaction with 37 new local regressions; `docs/design/2026-09-08-network-group-reset.md`; complete generation migration and interactive review pending | — | structured self-review | — |
...
| P2-RUN-03 | P2 | Presentation | In Progress | Phases 03 and 07 | `AsyncRelayCommandTests`; Master/Settings pending-applied-rollback tests; shared ConnectionSamplingSettingsCoordinator with 44 new local and CI regressions; `docs/design/2026-09-08-connection-sampling-settings-coordinator.md`; presentation `.Instance` freeze gate; `docs/architecture/evidence/phase-03-mutation-network-lifetime.md`; full Phase 07 migration pending | — | structured self-review | — |
