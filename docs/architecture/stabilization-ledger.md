...
| P2-RUN-03 | P2 | Presentation | In Progress | Phases 03 and 07 | `AsyncRelayCommandTests`; Master/Settings pending-applied-rollback tests; shared ConnectionSamplingSettingsCoordinator with 44 new local regressions; `docs/design/2026-09-08-connection-sampling-settings-coordinator.md`; presentation `.Instance` freeze gate; `docs/architecture/evidence/phase-03-mutation-network-lifetime.md`; full Phase 07 migration pending | — | structured self-review | — |
