...
| P2-SET-03 | P2 | Presentation | In Progress | Phase 05 | connection-test dialog validation and batch saving fixed in `027d1c7`; custom accent batch in `b773f39`; six preference groups now reset as complete batches, with 26 new local regressions; `docs/design/2026-09-08-preference-group-reset.md`; startup group now uses an admitted retained transaction with 15 new local regressions; `docs/design/2026-09-08-startup-group-reset.md`; network groups and interactive review pending | — | structured self-review | — |
