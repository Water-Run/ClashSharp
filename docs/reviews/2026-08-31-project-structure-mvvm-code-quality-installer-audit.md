...
定位：本文件保留 2026-08-31 的结构、权限边界与验证快照；当前开发状态和执行队列见 [2026-09-06 开发状态与推进计划](2026-09-06-development-status-and-next-steps.md)。更早文档中的 Rust/Slint 双轨、旧项目数量和旧测试计数不再代表现状。
